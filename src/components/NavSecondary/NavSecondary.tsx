// TODO: Create default texts object and assign in function params or NavSecondary.defaultProps instead of at each use case then re-enable control in story
